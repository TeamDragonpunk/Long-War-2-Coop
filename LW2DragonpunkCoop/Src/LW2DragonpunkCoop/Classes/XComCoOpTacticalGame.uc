...
static event class<GameInfo> SetGameType(string MapName, string Options, string Portal) 
{
	...
	{
		GameInfoClassToUse = "LW2DragonpunkCoop.XComCoOpTacticalGame";
	}
...
defaultproperties
{
	GameReplicationInfoClass = class'LW2DragonpunkCoop.XComMPCOOPGRI'
	PlayerControllerClass=class'LW2DragonpunkCoop.XComCoOpTacticalController'
	m_bMatchStarting=false
